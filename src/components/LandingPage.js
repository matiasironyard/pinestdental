        ...
        <Segment style={{ padding: "0em" }} vertical>
            ...
            <Grid.Row textAlign="center" centered>
              ...
              <Grid.Column width={4} style={{ paddingBottom: "5em", paddingTop: "5em" }}>
							{reviews[0] ? (
								<Item.Group>
								<Item>
		 <Item.Image size='tiny' src={reviews[0].profile_photo_url} />
		 ...
		 <Item.Content>
			 ...
			 <Item.Extra>{reviews[0].author_name}</Item.Extra>
              ...
              <Grid.Column width={5} style={{ paddingBottom: "5em", paddingTop: "5em" }}>
							{reviews[1] ? (
								<Item.Group>
								<Item>
		 <Item.Image size='tiny' src={reviews[1].profile_photo_url} />
